...
class ContactMe extends Component {
  ...
  handleSubmit = e => {
    ...
    render() {
        ...
        let containerClasses = 'contact-form-container';
        ...
        <form name={this.props.name} method="post" onSubmit={this.handleSubmit} data-netlify-recaptcha="true">
          <div className={containerClasses}>
            ...
            <div>
              ...
              {canSubmit && <button className="btn btn-primary" size="xx-large" text="Send" linkType="form" />}
              {!canSubmit && <button className="btn btn-primary"  size="xx-large" text="Send" linkType="form" inactive={true} />}
            </div>
          </div>
        </form>
      }
