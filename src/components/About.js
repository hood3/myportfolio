            ...
            <Col className="colum" md={6} sm={12}>
                <div className="about-wrapper__info">
                    <p className="about-wrapper__info-text">
                        ...
                        to gain more computer knowledge, and obtain a Bachelor of Science Degree in Computer Science. 
                        ...
                        development so my layouts will be dynamic and will fit any device’s screen, large or small. As a systems administrator, 
                        one of the things I love is that if I am doing my job right, no one will ever know I was there, everything will just work
                        perfectly and smoothly. Clients will be free to do what they do best without ever having to worry about their servers, or 
                        even fully understand how they work. I love being able to provide that kind of peace of mind for my clients, and love 
                        watching them be productive thanks to my efforts. I am committed to my passion to continue learning, to help others, and 
                        to try to solve problems. Coordinating projects with team members in college and previous employments has been profuse.
                        Therefore, I am eager for an opportunity to make an impact at a fast-growing, high-expectation company.                         
                    </p>  
